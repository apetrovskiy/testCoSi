...
import unittest
from src.main.java.training.graphs.a01_kingdom_roads.a01_new_road_system.solution import newRoadSystem


ROAD_REGISTER_01 = [[False, True,  False, False],
...
ROAD_REGISTER_03 = [[False, True,  False],
                [False, False, False],
                [True,  False, False]]
